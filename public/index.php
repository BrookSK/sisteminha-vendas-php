...
$router->group('/admin', function($r) {
    ...
    $r->get('/admin/site-clients', 'Controllers\\SiteClientsController@index');
    $r->post('/admin/site-clients/create', 'Controllers\\SiteClientsController@create');
    $r->post('/admin/site-clients/update', 'Controllers\\SiteClientsController@update');
    $r->post('/admin/site-clients/delete', 'Controllers\\SiteClientsController@delete');
    $r->get('/admin/site-clients/options', 'Controllers\\SiteClientsController@options');
